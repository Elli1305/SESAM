...
public class SesamUserServiceImpl implements SesamUserService {
    ...
    @Override
    public SesamUser createUser(

        final SesamUserCmd userCmd) {
    ...
    @Override
    public void createPasswordResetToken(final SesamUser user, finalString token) {
    ...
    public void updatePasswordWithToken(final String token, final String password) {
        ...
        finalSesamUser user = passwordResetToken.getUser();
    ...
    private void validatePassword(finalString password) {
