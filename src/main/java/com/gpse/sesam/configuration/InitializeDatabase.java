...
public class InitializeDatabase implements InitializingBean {
	...
	public InitializeDatabase(final LocationService locationService, final SesamUserService userService,
							  final CredentialService credentialService,
							  final CredentialCmdService credentialCmdService,
	...
	private List<Location> createLocations() {
		...
		for (int i = 0; i < 6; i++) {
			final Floor floor = new Floor(i % 2, "src/main/resources/citec-gebaeudeplan.png");
			...
			floors.add(floor);
			final Floor floor2 = new Floor(i % 2, "src/main/resources/citec-gebaeudeplan.png");
	...
	private List<Category> createCredentialCategories() {
		...
		final Floor floor3 = new Floor(1, "src/main/resources/citec-gebaeudeplan.png");
		...
		final Floor floor4 = new Floor(1, "src/main/resources/citec-gebaeudeplan.png");
