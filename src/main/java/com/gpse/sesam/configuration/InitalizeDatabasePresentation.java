...
public class InitalizeDatabasePresentation implements InitializingBean {
	...
	private List<Credential> createCredentials() {
		...
		//Tür 1
		final Coordinate coordinate = new Coordinate(new BigDecimal(-83.62), new BigDecimal(-12.49));
		final Coordinate coordinate1 = new Coordinate(new BigDecimal(-77), new BigDecimal(-12.49));

		//Tür 2
		final Coordinate coordinate2 = new Coordinate(new BigDecimal(-45.76), new BigDecimal(-12.49));
		final Coordinate coordinate3 = new Coordinate(new BigDecimal(-39.64), new BigDecimal(-12.49));

		//Room 0.007
		final Coordinate coordinate4 = new Coordinate(new BigDecimal(-86.62), new BigDecimal(-90));
		final Coordinate coordinate5 = new Coordinate(new BigDecimal(-86.62), new BigDecimal(-12.49));

		final Coordinate coordinate6 = new Coordinate(new BigDecimal(-37.10), new BigDecimal(-12.49));
		final Coordinate coordinate7 = new Coordinate(new BigDecimal(-37.10), new BigDecimal(-90));

		final List<Coordinate> coordinates = new ArrayList<>();
		coordinates.add(coordinate);
		coordinates.add(coordinate1);
		final List<Coordinate> coordinates1 = new ArrayList<>();
		coordinates1.add(coordinate2);
		coordinates1.add(coordinate3);
		final List<Coordinate> coordinates2 = new ArrayList<>();
		...
		final List<FormEntry> form4 = formTraining();
