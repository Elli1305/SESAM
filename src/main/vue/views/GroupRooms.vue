        ...
        <q-card-section>
          ...
          >
            <template v-slot:top-right>
              ...
              <q-input class="q-ml-xs" borderless dense debounce="250" v-model="searchinput"
                       :placeholder="t('common.search')">
                <template v-slot:append>
                  <q-icon name="search"/>
                </template>
            ...
            <template v-slot:body-cell-actions="props">
              <q-td :props="props">
                <q-checkbox v-model="props.row.name"
                            @update:model-value="getDoors(props.row.room); checkIfSelected(props.row.name, props.row.room)"/>
              </q-td>
            </template>
          </q-table>
        </q-card-section>
...
export default {
  ...
  setup() {
    ...
    const columns = [
      ...
      {
        name: 'doorconfig',
        label: t('editor.groupRooms.doorconfig'),
        style: 'width: 8em',
