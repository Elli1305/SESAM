    ...
    >
      <div class="q-col-gutter-md row">
        <div class="col-6">
          ...
          <p>Alternativ dazu können Sie eine zuvor exportierte Datei importieren. Klicken Sie dazu auf die Schaltfläche
        ...
        <q-form ref="form" class="col-6" @submit.prevent>
          <q-input v-model="host" :disable="file != null" class="q-mb-md" type="url" label="URL einer anderen Instanz"/>
          <q-file v-model="file" :disable="host != null && host.length > 0" accept="application/json" label="Exportierte Datei hochladen"/>
        </q-form>
      </div>
    </q-step>
